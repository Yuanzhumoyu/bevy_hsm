...
fn is_off(_entity: In<HsmStateContext>, input: Res<ButtonInput<KeyCode>>) -> bool {
...
fn register_condition(
    ...
    let id = commands.register_system(is_off);
    action_systems.insert("is_off", id);
...
fn setup(mut commands: Commands) {
    ...
    commands.entity(start_state_id).insert((
        ...
        HsmOnEnterCondition::new("is_off"),
